    ...
    return(
        ...
        <Helmet>
            <section>
                <Container>
                    <Row>
                <h1 className="space" > Vrste Najma </h1>

                <h4> - CHARTER BEZ SKIPERA </h4>
            
                <p>
                Ako imate dovoljno nautičkog iskustva i posjedujete potrebne dozvole, nudimo Vam mogućnost da unajmite brod bez skipera i 
                drugih članova posade.
                Ako uzmete brod bez posade, važno je da imate na umu da ste upravo Vi odgovorni za opću sigurnost na brodu. Na brodu je uvijek
                važno da se zna 
                tko je kapetan i koga se treba bespogovorno slušati u opasnosti (demokracija u ovakvim situacijama može samo naškoditi).
                U slučaju da vi imate tu ulogu, shvatite da je na Vama velika odgovornost.
                </p>

                <p>
                Ipak, iako je samo jedan kapetan, svi članovi posade podjednako dijele odgovornost za brod i opću dobrobit. Jedan čovjek 
                ne može sam stizati upravljati brodom, brinuti se o njegovoj ispravnosti i sigurnosti, određivati rute, kuhati, čistiti 
                i uz to se još i zabaviti i odmorit (jer, ipak, ste na odmoru). Svi koji se nađu na brodu moraju preuzeti dio odgovornosti
                i obaveza. Ne radi se samo o izbjegavanju opasnosti od havarija ili lošeg vremena, već je važno i da brod održavate čistim 
                i urednim, da pazite na brodski inventar, i da poštujete pravila ponašanja na moru (radi sebe i drugih nautičara). Na taj 
                način se smanjuje mogućnost nastanka bilo kakvih problema, svi se dobro zabavljaju, uče i vrlo je vjerojatno da ćete se i
                dogodine poželjeti vratiti. 
                </p>

                <p>
                Da biste uopće smjeli unajmiti brod bez profesionalnog skipera, morate imati potrebne dozvole. To uključuje valjanu 
                skipersku dozvolu i dozvolu za korištenje VHF-a, koje morate imati sa sobom na brodu (originale!). Također, na brodu
                morate imati i popis posade ovjeren u nadležnoj Lučkoj kapetaniji. Ukoliko se popis bude morao mijenjati tijekom putovanja,
                nužno je da svaku promjenu prijavite trenutno nadležnoj Kapetaniji.
                
                </p>

                <h4><br/> - CHARTER SA SKIPEROM I/ILI HOSTESOM </h4>

                <p>
                Ako nemate dovoljno nautičarskog iskustva, ne posjedujete valjane dozvole ili jednostavno se želite samo odmarati i opuštati tijekom putovanja, unajmit ćete skipera, a možda i hostesu (ovisno o Vašim potrebama, željama i o tome koliko mjesta na brodu imate).
                </p>
